...
- Read `references/agent-contracts.md` when defining what each agent may and may not do.
- Read `references/output-schema.md` when you need stable intermediate and final output fields.
- Read `references/vuln-checklists.md` when choosing what each vulnerability-oriented subagent should inspect.
- Read `references/prompt-templates.md` when drafting reusable role prompts and shared constraints.
